...
import { BellIcon, BotMessageSquare, HomeIcon, UsersIcon } from "lucide-react";

const Sidebar =()=>{
    const {authUser} =useAuthUser();
    const location = useLocation();
    const currentPath=location.pathname;
     return <aside className="w-64 bg-base-200 border-r bprder-base-300 hidden lg:flex flex-col h-screen sticky top-0">
